class ConstString {
  ...
  static const String introimage = "image";
  static const String introTitle = "title";
  static const String introSubTitle = "subtitle";
  ...
  static const String userLoginMassage =
      "You have successfully registered in our app and start working in it.";

  /// Home screen
  static const String welcome = "Welcome,";
  static const String fashionTitle = "Our Fashions App";
  static const String bottomIcon = "icon";
  static const String bottomLable = "lable";
  static const String banerButton = "Get Now";
